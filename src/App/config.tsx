...
export const config: Config = {
  name: {
    display: 'Hey! I am Bin Wan. I am Postdoc at Geneva Psychiatry and a previous PhD at MPI CBS, and interested in Computational Neurogenetics',
    aria: '',
  },
  title: {
    display: 'The key question I am asking is: How the human mind (from behavior, ideology, to brain circuits) is shaped by nature and nurture',
    aria: '',
  },
